...
public class MainActivity extends AppCompatActivity {
        ...
        mCreateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mContentEditText.getText().toString().isEmpty()){
                    mContentEditText.setError("Enter the text first");
    ...
    private void createPdf() throws FileNotFoundException, DocumentException {
        ...
        if (!docsFolder.exists()) {
            docsFolder.mkdir();
            Log.i(TAG, "Create a new PDF folder");
        }
    ...
    private void previewPdf() {
        ...
        if (list.size() > 0) {
            ...
            Toast.makeText(this,"Download PDF reader to see the result ",Toast.LENGTH_SHORT).show();
        }
    }
}